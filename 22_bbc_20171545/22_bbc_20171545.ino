...
// Servo adjustment
#define _DUTY_NEU 1500 //* 0deg
#define _DUTY_MAX 2300 //* 2300,  -15deg d
#define _DUTY_MIN 700 //* 700,  25deg e
...
void loop() {
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(120, 0.5)); // Replace n with your desired value 120!
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (1326 + -7.8*a_value + 0.0171*a_value*a_value + -1.54*0.00001*a_value*a_value*a_value + 4.03*0.000000001*a_value*a_value*a_value*a_value);
}
